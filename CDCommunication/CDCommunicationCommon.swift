...
@objc public protocol CDCommunicationCommonDelegate {
    ...
    @objc optional func networkReachabilityObserver(_ typeReachability: CDCommunicationCommon.typeReachability)
...
@objc public class CDCommunicationCommon: NSObject {
    @objc public static var shared: CDCommunicationCommon = {
        let instance = CDCommunicationCommon()
        return instance
    }()
    ...
    var calldriveVersion: Int = 0
    var webDav: String = "remote.php/webdav"
    var dav: String = "remote.php/dav"
    
    var cookies: [String:[HTTPCookie]] = [:]

    var delegate: CDCommunicationCommonDelegate?
    
    @objc public let sessionIdentifierDownload: String = "com.calldrive.session.download"
    @objc public let sessionIdentifierUpload: String = "com.calldrive.session.upload"
    ...
    @objc public func setup(account: String? = nil, user: String, userId: String, password: String, urlBase: String, userAgent: String, webDav: String?, dav: String?, calldriveVersion: Int, delegate: CDCommunicationCommonDelegate?) {
        ...
        self.setup(calldriveVersion: calldriveVersion)
    ...
    @objc public func setup(delegate: CDCommunicationCommonDelegate?) {
    ...
    @objc public func setup(calldriveVersion: Int) {
        
        self.calldriveVersion = calldriveVersion
    }
