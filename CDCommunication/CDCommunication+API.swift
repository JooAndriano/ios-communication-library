...
extension CDCommunication {
    ...
    @objc public func checkServer(serverUrl: String, completionHandler: @escaping (_ errorCode: Int, _ errorDescription: String) -> Void) {
        ...
        guard let url = CDCommunicationCommon.shared.StringToUrl(serverUrl) else {
    ...
    @objc public func getExternalSite(customUserAgent: String? = nil, addCustomHeaders: [String: String]? = nil, completionHandler: @escaping (_ account: String, _ externalFiles: [CDCommunicationExternalSite], _ errorCode: Int, _ errorDescription: String) -> Void) {
        
        let account = CDCommunicationCommon.shared.account
        var externalSites: [CDCommunicationExternalSite] = []
        ...
        sessionManager.request(url, method: method, parameters: nil, encoding: URLEncoding.default, headers: headers, interceptor: nil).validate(statusCode: 200..<300).responseJSON { (response) in
            ...
            case .success(let json):
                ...
                for (_, subJson):(String, JSON) in ocsdata {
                    let extrernalSite = CDCommunicationExternalSite()
    ...
    @objc public func getServerStatus(serverUrl: String, customUserAgent: String? = nil, addCustomHeaders: [String: String]? = nil, completionHandler: @escaping (_ serverProductName: String?, _ serverVersion: String? , _ versionMajor: Int, _ versionMinor: Int, _ versionMicro: Int, _ extendedSupport: Bool, _ errorCode: Int, _ errorDescription: String) -> Void) {
        ...
        guard let url = CDCommunicationCommon.shared.createStandardUrl(serverUrl: serverUrl, endpoint: endpoint) else {
    ...
    @objc public func downloadPreview(fileNamePathOrFileId: String, fileNamePreviewLocalPath: String, widthPreview: Int, heightPreview: Int, fileNameIconLocalPath: String? = nil, sizeIcon: Int = 0, customUserAgent: String? = nil, addCustomHeaders: [String: String]? = nil, endpointTrashbin: Bool = false, useInternalEndpoint: Bool = true, completionHandler: @escaping (_ account: String, _ imagePreview: UIImage?, _ imageIcon: UIImage?, _ errorCode: Int, _ errorDescription: String) -> Void) {
        ...
        if useInternalEndpoint {
            ...
            if endpointTrashbin {
                ...
                guard let fileNamePath = CDCommunicationCommon.shared.encodeString(fileNamePathOrFileId) else {
            ...
            url = CDCommunicationCommon.shared.createStandardUrl(serverUrl: CDCommunicationCommon.shared.urlBase, endpoint: endpoint)
            
        } else {
            
            url = CDCommunicationCommon.shared.StringToUrl(fileNamePathOrFileId)
        }
    ...
    @objc public func getUserProfile(customUserAgent: String? = nil, addCustomHeaders: [String: String]? = nil, completionHandler: @escaping (_ account: String, _ userProfile: CDCommunicationUserProfile?, _ errorCode: Int, _ errorDescription: String) -> Void) {
        ...
        sessionManager.request(url, method: method, parameters: nil, encoding: URLEncoding.default, headers: headers, interceptor: nil).validate(statusCode: 200..<300).responseJSON { (response) in
            ...
            case .success(let json):
                ...
                let statusCode = json["ocs"]["meta"]["statuscode"].int ?? CDCommunicationError().getInternalError()
                if statusCode == 200 {
                    
                    let userProfile = CDCommunicationUserProfile()
    ...
    @objc public func iosHelper(fileNamePath: String, serverUrl: String, offset: Int, limit: Int, customUserAgent: String? = nil, addCustomHeaders: [String: String]? = nil, completionHandler: @escaping (_ account: String, _ files: [CDCommunicationFile], _ errorCode: Int, _ errorDescription: String) -> Void) {
    ...
    @objc public func getActivity(since: Int, limit: Int, objectId: String?, objectType: String?, previews: Bool, customUserAgent: String? = nil, addCustomHeaders: [String: String]? = nil, completionHandler: @escaping (_ account: String, _ activities: [CDCommunicationActivity], _ errorCode: Int, _ errorDescription: String) -> Void) {
        
        let account = CDCommunicationCommon.shared.account
        var activities: [CDCommunicationActivity] = []
        ...
        sessionManager.request(url, method: method, parameters: parameters, encoding: URLEncoding.default, headers: headers, interceptor: nil).validate(statusCode: 200..<300).responseJSON { (response) in
            ...
            case .success(let json):
                ...
                let ocsdata = json["ocs"]["data"]
                for (_, subJson):(String, JSON) in ocsdata {
                    let activity = CDCommunicationActivity()
                    ...
                    if let datetime = subJson["datetime"].string {
                        if let date = CDCommunicationCommon.shared.convertDate(datetime, format: "yyyy-MM-dd'T'HH:mm:ssZZZZZ") {
                            activity.date = date
                        }
                    }
    ...
    @objc public func getNotifications(customUserAgent: String? = nil, addCustomHeaders: [String: String]? = nil, completionHandler: @escaping (_ account: String, _ notifications: [CDCommunicationNotifications]?, _ errorCode: Int, _ errorDescription: String) -> Void) {
    
        let account = CDCommunicationCommon.shared.account
        var notifications: [CDCommunicationNotifications] = []
        ...
        sessionManager.request(url, method: method, parameters: nil, encoding: URLEncoding.default, headers: headers, interceptor: nil).validate(statusCode: 200..<300).responseJSON { (response) in
            ...
            case .success(let json):
                ...
                if statusCode == 200 {
                    let ocsdata = json["ocs"]["data"]
                    for (_, subJson):(String, JSON) in ocsdata {
                        let notification = CDCommunicationNotifications()
    ...
    @objc public func setNotification(serverUrl: String?, idNotification: Int, method: String, customUserAgent: String? = nil, addCustomHeaders: [String: String]? = nil, completionHandler: @escaping (_ account: String, _ errorCode: Int, _ errorDescription: String) -> Void) {
        ...
        if serverUrl == nil {
            ...
            url = CDCommunicationCommon.shared.StringToUrl(serverUrl!)
        }
