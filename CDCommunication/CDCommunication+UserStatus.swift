//
//  CDCommunication+UserStatus.swift
//  CDCommunication
//
...
extension CDCommunication {
    ...
    @objc public func getUserStatusPredefinedStatuses(customUserAgent: String? = nil, addCustomHeaders: [String: String]? = nil, completionHandler: @escaping (_ account: String, _ userStatuses: [CDCommunicationUserStatus]?, _ errorCode: Int, _ errorDescription: String) -> Void) {
    
        let account = CDCommunicationCommon.shared.account
        var userStatuses: [CDCommunicationUserStatus] = []
            ...
            case .success(let json):
                ...
                if statusCode == 200 {
                    ...
                    for (_, subJson):(String, JSON) in ocsdata {
                        let userStatus = CDCommunicationUserStatus()
    ...
    @objc public func getUserStatusRetrieveStatuses(limit: Int, offset: Int, customUserAgent: String? = nil, addCustomHeaders: [String: String]? = nil, completionHandler: @escaping (_ account: String, _ userStatuses: [CDCommunicationUserStatus]?, _ errorCode: Int, _ errorDescription: String) -> Void) {
