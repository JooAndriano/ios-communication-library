...
extension CDCommunication {
    ...
    */
    ...
    @objc public func readShares(reshares: Bool = false, subfiles: Bool = false, customUserAgent: String? = nil, addCustomHeaders: [String: String]? = nil, completionHandler: @escaping (_ account: String, _ shares: [CDCommunicationShare]?, _ errorCode: Int, _ errorDescription: String) -> Void) {
    ...
    @objc public func readShares(path: String, reshares: Bool = false, subfiles: Bool = false, customUserAgent: String? = nil, addCustomHeaders: [String: String]? = nil, completionHandler: @escaping (_ account: String, _ shares: [CDCommunicationShare]?, _ errorCode: Int, _ errorDescription: String) -> Void) {
    ...
    @objc public func readShares(idShare: Int, reshares: Bool = false, subfiles: Bool = false, customUserAgent: String? = nil, addCustomHeaders: [String: String]? = nil, completionHandler: @escaping (_ account: String, _ shares: [CDCommunicationShare]?, _ errorCode: Int, _ errorDescription: String) -> Void) {
    ...
    private func readShares(path: String? = nil, idShare: Int = 0, reshares: Bool, subfiles: Bool, customUserAgent: String? = nil, addCustomHeaders: [String: String]? = nil, completionHandler: @escaping (_ account: String, _ shares: [CDCommunicationShare]?, _ errorCode: Int, _ errorDescription: String) -> Void) {
        ...
        sessionManager.request(url, method: method, parameters: parameters, encoding: URLEncoding.default, headers: headers, interceptor: nil).validate(statusCode: 200..<300).responseData { (response) in
            ...
            case .success( _):
                if let data = response.data {
                    let shares = CDDataFileXML().convertDataShare(data: data)
    ...
    */
    ...
    @objc public func searchSharees(search: String = "", page: Int = 1, perPage: Int = 200, itemType: String = "file", lookup: Bool = false, customUserAgent: String? = nil, addCustomHeaders: [String: String]? = nil, completionHandler: @escaping (_ account: String, _ sharees: [CDCommunicationSharee]?, _ errorCode: Int, _ errorDescription: String) -> Void) {
        ...
        sessionManager.request(url, method: method, parameters: parameters, encoding: URLEncoding.default, headers: headers, interceptor: nil).validate(statusCode: 200..<300).responseJSON { (response) in
            ...
            case .success(let json):
                ...
                if statusCode == 200 {
                    var sharees: [CDCommunicationSharee] = []
                    for shareType in ["users", "groups", "remotes", "remote_groups", "emails", "circles", "rooms", "lookup"] {
                        for (_, subJson):(String, JSON) in json["ocs"]["data"]["exact"][shareType] {
                            let sharee = CDCommunicationSharee()
    ...
    */
    ...
    @objc public func createShare(path: String, shareType: Int, shareWith: String, password: String? = nil, permissions: Int = 1, customUserAgent: String? = nil, addCustomHeaders: [String: String]? = nil, completionHandler: @escaping (_ account: String, _ share: CDCommunicationShare?, _ errorCode: Int, _ errorDescription: String) -> Void) {
    ...
    */
    ...
    private func convertResponseShare(json: JSON) -> CDCommunicationShare {
        let share = CDCommunicationShare()
        ...
        if let expiration = json["ocs"]["data"]["expiration"].string {
            if let date = CDCommunicationCommon.shared.convertDate(expiration, format: "YYYY-MM-dd HH:mm:ss") {
